...
from sia.memory.conversation import SiaMemoryConversation
from sia.memory.individual import SiaMemoryIndividual
...
class SiaMemory:
    ...
    def __init__(self, sia, db_path: str, character: SiaCharacter):
        ...
        self.sia = sia
        self.individual = SiaMemoryIndividual(self.sia, self.db_path)
        self.conversation = SiaMemoryConversation(self.sia, self.db_path, self.character)
